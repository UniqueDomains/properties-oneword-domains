# Available .PROPERTIES One-Word Domains (5,621,940)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C112%20rows-8250df">
...
> **Important:** this repository is a **public 9,112-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,940 domains** on the canonical page below.

**Public extract:** 9,112 rows · **Live catalog:** 5,621,940 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/properties?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_properties_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/properties?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_properties_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./properties.csv">CSV</a> / <a href="./properties.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_properties_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_properties_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .PROPERTIES search](https://unique.domains/domains/tld/properties?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_properties_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .PROPERTIES search](https://unique.domains/domains/tld/properties?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_properties_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./properties.csv) or [Download JSON](./properties.json)
...
- `properties.csv` — public CSV extract (9,112 rows)
- `properties.json` — public JSON extract (9,112 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,112-row public sample | 5,621,940 live domains                           |
...
| ------------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------- |
| wizard.properties   | available | $10.99    | $50.99        | 118            | 46     | 6      | name.com          |
| domain.properties   | resell    | —         | —             | 80             | 64     | 6      | Sav.com, LLC      |
| live.properties     | premium   | $1,000    | $1,000        | 108            | 55     | 4      | name.com          |
| snap.properties     | available | $10.99    | $50.99        | 90             | 46     | 4      | name.com          |
...
| open.properties     | resell    | —         | —             | 106            | 61     | 4      | Porkbun LLC       |
| life.properties     | premium   | $260      | $260          | 84             | 50     | 4      | namecheap         |
| creator.properties  | available | $10.99    | $50.99        | 70             | 44     | 7      | name.com          |
| future.properties   | resell    | —         | —             | 94             | 55     | 6      | Sav.com, LLC - 17 |
| gold.properties     | premium   | $260      | $260          | 72             | 49     | 4      | namecheap         |
| order.properties    | available | $10.99    | $50.99        | 78             | 41     | 5      | name.com          |
| good.properties     | resell    | —         | —             | 82             | 55     | 4      | Sav.com, LLC - 20 |
| law.properties      | premium   | $260      | $260          | 82             | 48     | 3      | namecheap         |
| learning.properties | available | $43.98    | —             | 76             | 41     | 8      | namecheap         |
| business.properties | resell    | —         | —             | 100            | 54     | 8      | Sav.com, LLC - 22 |
| zen.properties      | premium   | $82.50    | —             | 80             | 47     | 3      | name.com          |
| service.properties  | available | $43.98    | —             | 70             | 41     | 7      | namecheap         |
| data.properties     | resell    | —         | —             | 70             | 53     | 4      | Porkbun LLC       |
...
> Unique Domains. *Available .PROPERTIES One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
