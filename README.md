...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C113%20rows-8250df">
...
**Public extract:** 9,113 rows · **Live catalog:** 9,113 domains
...
- `properties.csv` — public CSV extract (9,113 rows)
- `properties.json` — public JSON extract (9,113 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,113-row public sample | 9,113 live domains                               |
...
> Unique Domains. *Available .PROPERTIES One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
