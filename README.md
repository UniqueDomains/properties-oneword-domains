...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C114%20rows-8250df">
...
> **Important:** this repository is a **public 9,114-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,940 domains** on the canonical page below.

**Public extract:** 9,114 rows · **Live catalog:** 5,621,940 domains
...
- `properties.csv` — public CSV extract (9,114 rows)
- `properties.json` — public JSON extract (9,114 rows)
...
| business.properties | resell    | —         | —             | 100            | 53     | 8      | Sav.com, LLC - 22 |
...
| ----------------------- | ------------------------------------------------ |
| 9,114-row public sample | 5,621,940 live domains                           |
...
> Unique Domains. *Available .PROPERTIES One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
